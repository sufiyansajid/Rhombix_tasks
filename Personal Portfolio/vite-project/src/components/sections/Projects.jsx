        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2"> Online Food Ordering System</h3>
              <p className="text-gray-400 mb-4">
                An Online Food Ordering System
                with a normalized SQL database, managing users, orders,
                restaurants, and payments.
              </p>
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sufiyansajid/Online-Food-Ordering-System.git"
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sufiyansajid/Snake-Water-Gun-Game.git"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/sufiyansajid/Real-State-Dashboard.git"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
